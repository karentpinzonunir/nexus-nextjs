...
// prerender: cross-product locales x top N ids
...
export default async function LibroDetallePage({ params }) {
  // defensivo: algunas versiones pasan params como Promise
  ...
  // pasamos dict y locale al componente cliente
